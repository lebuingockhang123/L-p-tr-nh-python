...
Date: 12/07/1997
Program: Define a function drawCircle. This function should expect a Turtle object, the coordinates of the
...
Enter the x coordinate of the center point: 25
Enter the y coordinate of the center point: 75
